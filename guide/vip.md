...
<a href="#head1">`申请内网IP`</a>

<a href="#head2">`CentOS系统VIP配置`</a>

<a href="#head3">`Ubuntu系统VIP配置`</a>

<a href="#head4">`解除VIP配置`</a>

<a href="#head5">`释放VIP`</a>

<a href='#head6'>`使用VIP与Keepalive配置服务高可用`</a>
